...
export type Counsellor = Database['public']['Tables']['Counsellor']['Row'];
export type AppointmentRecord = Database['public']['Tables']['Appointment']['Row'];
export type DiscussionRecord = Database['public']['Tables']['Discussion']['Row'];
export type ReplyRecord = Database['public']['Tables']['Discussion_Reply']['Row'];
export type ResourceRecord = Database['public']['Tables']['Resource']['Row'];
export type NotificationRecord = Database['public']['Tables']['Notification']['Row'];
export type ApplicationRecord = Database['public']['Tables']['Application']['Row'];
